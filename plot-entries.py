...
fig.tight_layout()
fig.savefig("plots/pubchem-count.png")
...
ax.set_yticklabels(labels=[f"{ytick:.2e}"])
fig.tight_layout()
fig.savefig("plots/chembl-compounds.png")
...
ax.set_yticklabels(labels=[f"{ytick:.2e}"])
fig.tight_layout()
fig.savefig("plots/pdb-entries.png")
...
ax.set_yticklabels(labels=[f"{ytick:.2e}"])
fig.tight_layout()
fig.savefig("plots/csd-structures.png")
...
fig.tight_layout()
fig.savefig("plots/all-entries.png")